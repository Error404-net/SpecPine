...
# ── Colour palette (WarGames green CRT phosphor — matches boot splash + menu,
#    see data/theme/palette.md "Primary" palette) ─────────────────────────────
C_BG       = (  0,   8,   4)   # near-black, green-tinted background
C_BAR      = (  0,  20,  10)   # slightly lighter bar
C_TEAL     = (  0, 220, 100)   # phosphor green accent / channel markers
C_WHITE    = (220, 255, 220)
C_GRAY     = (  0,  80,  40)   # dim green (secondary text / hints)
C_CYAN     = ( 60, 220, 220)   # hint cyan (palette.md "Hint" role)
C_BLACK    = (  0,   8,   4)   # same as bg — keeps idle waterfall rows on-palette
...
def build_static(fb: bytearray, freq_start_khz: int | None,
    ...
    _text(fb, "SpecPine Waterfall", 4, TITLE_Y0 + 4, white)
